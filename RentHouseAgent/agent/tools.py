...
TOOLS = [
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "listing_platform": {"type": "string", "description": "平台：链家/安居客/58同城，默认安居客"},
                    "district": {"type": "string", "description": "行政区：海淀/朝阳"},
                    "area": {"type": "string", "description": "商圈：西二旗/上地"},
                    "min_price": {"type": "integer", "description": "最低租金（元）"},
                    "max_price": {"type": "integer", "description": "最高租金（元）"},
                    "bedrooms": {"type": "string", "description": "卧室数：1,2"},
                    "rental_type": {"type": "string", "description": "整租/合租"},
                    "decoration": {"type": "string", "description": "装修：精装/简装"},
                    "orientation": {"type": "string", "description": "朝向：朝南/南北"},
                    "elevator": {"type": "string", "description": "电梯：true/false"},
                    "min_area": {"type": "integer", "description": "最小面积（㎡）"},
                    "max_area": {"type": "integer", "description": "最大面积（㎡）"},
                    "property_type": {"type": "string", "description": "物业类型：住宅"},
                    "subway_line": {"type": "string", "description": "地铁线：13号线"},
                    "max_subway_dist": {"type": "integer", "description": "最大地铁距离（米）"},
                    "subway_station": {"type": "string", "description": "地铁站：车公庄站"},
                    "utilities_type": {"type": "string", "description": "水电：民水民电"},
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "q": {"type": "string", "description": "关键词：西二旗"},
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "type": {"type": "string", "description": "类型：shopping(商超)/park(公园)"},
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "name": {"type": "string", "description": "地标名称：西二旗站/国贸"}
                },
                "required": ["name"]
            }
        }
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "landmark_id": {"type": "string", "description": "地标ID：SS_001/LM_002"}
                },
                "required": ["landmark_id"]
            }
        }
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "community": {"type": "string", "description": "小区名：建清园(南区)/保利锦上(二期)"},
                    "listing_platform": {"type": "string", "description": "平台：链家/安居客/58同城，默认安居客"},
                    "page": {"type": "integer", "description": "页码，默认1"},
                    "page_size": {"type": "integer", "description": "每页条数，默认10"}
                },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "house_id": {"type": "string", "description": "房源ID：HF_2001"},
                    "listing_platform": {"type": "string", "description": "平台：链家/安居客/58同城"}
                },
